...
{
    public partial class MainForEmployee : Form
    {
        public MainForEmployee()
        {
            InitializeComponent();
        }
        ...
        private void MainForEmployee_FormClosing(object sender, FormClosingEventArgs e)
        {
